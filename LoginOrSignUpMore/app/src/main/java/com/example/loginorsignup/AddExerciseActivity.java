...
public class AddExerciseActivity extends AppCompatActivity implements ExerciseListInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(AddExerciseActivity.this, NewWorkoutActivity.class);
    ...
    public void onItemClick(int position) {
        sendExerciseDataBack(items.get(position).getName());
    }
    private void sendExerciseDataBack(String exerciseName) {
        Intent resultIntent = new Intent();
        resultIntent.putExtra("EXERCISE_NAME", exerciseName); // Replace "Exercise Name" with the actual exercise name
        // Put other exercise data in a similar manner
